...
- **FR-013**: El sistema DEBE validar y sanitizar todas las entradas de usuario en cliente y servidor para prevenir inyección de código y datos maliciosos
...
- **NFR-001**: Búsqueda fuzzy debe responder en menos de 500ms (p95, con hasta 1000 productos en catálogo)
- **NFR-002**: Generación de PDF debe completar en menos de 3 segundos (p95, para cotizaciones de hasta 50 ítems)
