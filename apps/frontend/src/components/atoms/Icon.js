...
export class Icon {
  ...
  getIconPath() {
    const paths = {
      ...
      download:
        "M12 2v12m0 0l-4-4m4 4l4-4M4 14h16a1 1 0 011 1v4a1 1 0 01-1 1H4a1 1 0 01-1-1v-4a1 1 0 011-1z",
      upload:
        "M12 16v-8m0 0L8 12m4-4l4 4M4 10h16a1 1 0 011 1v4a1 1 0 01-1 1H4a1 1 0 01-1-1v-4a1 1 0 011-1z",
      alert:
        "M12 9v2m0 4v2m7.2-12.6l-8.4-2.4a1 1 0 00-.8 0l-8.4 2.4a1 1 0 00-.6.9v10.2a1 1 0 00.6.9l8.4 2.4a1 1 0 00.8 0l8.4-2.4a1 1 0 00.6-.9V9.3a1 1 0 00-.6-.9z",
      ...
      users:
        "M17 20h5v-2a3 3 0 00-5.856-1.487M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 0a2 2 0 11-4 0 2 2 0 014 0zM5 20a7 7 0 1110-9.999",
      circle:
      ...
      unlock:
        "M12 2C10.34 2 9 3.34 9 5v3H5c-1.66 0-3 1.34-3 3v8c0 1.66 1.34 3 3 3h14c1.66 0 3-1.34 3-3v-8c0-1.66-1.34-3-3-3h-4V9c0-1.66-1.34-3-3-3zm0 2c.55 0 1 .45 1 1v3h-2V5c0-.55.45-1 1-1zm-8 6h14v8H4v-8z",
    };
